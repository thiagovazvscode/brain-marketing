...
const whatsappMessage =
  "Olá Thiago, quero conversar sobre a proposta para MV Imóveis";
...
const heroPills = ["Tráfego Pago", "Belém, PA"];
...
const contextCards = [
  ...
  {
    icon: MapPin,
    text: "Campanhas segmentadas por bairro em Belém atraem quem realmente busca imóvel na região",
  },
  {
    icon: TrendingUp,
...
const processSteps = [
  {
    icon: ClipboardList,
    title: "Briefing",
    desc: "Entendemos o perfil de comprador ideal, os imóveis em destaque e as regiões de atuação da MV.",
  },
  {
    icon: Palette,
    title: "Estrutura",
    desc: "Criamos os criativos, os textos e configuramos as campanhas segmentadas por bairro.",
  },
  {
    icon: Rocket,
    title: "Ativação",
    desc: "Colocamos as campanhas no ar, conectadas diretamente ao WhatsApp da equipe MV.",
  },
  {
    icon: BarChart2,
    title: "Escala",
        ...
        <div className="mx-auto max-w-4xl text-center">
          ...
          <MotionReveal delay={0.16}>
            <p className="mx-auto mt-6 max-w-2xl text-balance text-base leading-relaxed text-gray-400 md:text-lg">
              ...
              qualificados de compradores de imóveis em Belém.
            </p>
          </MotionReveal>
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <MotionReveal delay={0.08}>
            <h2 className="mt-6 font-display text-balance text-3xl font-medium leading-[1.1] text-white sm:text-4xl">
              Quem aparece primeiro no feed, agenda a visita primeiro.
            </h2>
          </MotionReveal>

          <MotionReveal delay={0.16}>
            <p className="mt-5 max-w-3xl text-balance text-base leading-relaxed text-gray-400 md:text-lg">
              Imobiliárias que dependem só de indicação e da vitrine física
              estão perdendo espaço para quem investe em tráfego pago
              segmentado. O comprador certo já está pesquisando imóvel em
              Belém agora — a pergunta é quem aparece primeiro pra ele.
            </p>
          </MotionReveal>
            ...
            <MotionReveal delay={0.08}>
              ...
              >
                ...
                <p className="mt-3 text-sm leading-relaxed text-gray-400">
                  Campanhas no Meta Ads (Instagram e Facebook) segmentadas por
                  bairro e perfil de comprador, conectadas ao WhatsApp da
                  equipe MV.
                </p>
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <MotionReveal delay={0.16}>
            <p className="mt-5 max-w-2xl text-balance text-base leading-relaxed text-gray-400 md:text-lg">
              Antes de qualquer anúncio, entendemos a MV Imóveis. Cada etapa
